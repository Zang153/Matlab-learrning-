...
function [c, b1, b2, BM] = wing_prop2(dist, desired_stringer_pitch, half_b, root_chord, taper_ratio, taper_dist_start, front_spar, rear_spar, thickness, tail_type)
    ...
    loading_data = get_wing_loading2(dist/1000, tail_type); % Stn in wingloading table in [m] but dist in [mm]. <-- sub-fn
